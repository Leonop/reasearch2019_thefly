...
# constant
# csv file name
CSV_FILE_NAME = "thefly_indmet.csv"
# csv title
CSV_TITLE = ["Date", "Name", "Time", "Sponsors", "Industry", "Comments", "Location"]
# start date
...
# head
HEADER = {
    "Cookie": "__cfduid=d08b40ff0a9987e40ff4168e4f723b0731575254425; _ga=GA1.2.388279356.1575254427; _jsuid=2779159458; __gads=ID=e89b2578e6b082cc:T=1575254427:S=ALNI_MagZrxG5vszuu6gSBP5gQZru-DNNQ; __qca=P0-136999229-1575254427470; _ccm_inf=1; filtersBN=agregarSimbolos%3D%26hot_stocks_filter%3Don%26rumors_filter%3Don%26general_news_filter%3Don%26periodicals_filter%3Don%26earnings_filter%3Don%26technical_analysis_filter%3Don%26insight_filter%3Don; TheflyUsTr=104.222.21.17.1576343738651107; PHPSESSID=kk0hu1mtkjc2se30ba0u315th6; _gid=GA1.2.992738281.1576343742; heatmaps_g2g_100767783=no; IC_ViewCounter_thefly.com=2; logglytrackingsession=88eda49e-9717-4b4f-bce3-03c5985e93e4; fc=%7B%22OTMzfjEwNDAxXzE2NTY0MzIwMH4xNjU2NDMyMDA%22%3A%221%3A1576542013203%22%2C%22NzE2fjEwNDAxXzE2NTgxNjYzNn4xNjU4MTY2MzY%22%3A%221%3A1576542059904%22%7D; pv=%7B%22d%22%3A%225%3A1575254450237%22%7D; _gat=1; _first_pageview=1",
...
def get_datas(date):
    ...
    lst_li = soup.find_all("li", class_="fpo_overlay IM")
    if lst_li:
        for li in lst_li:
